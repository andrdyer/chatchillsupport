              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 text-sm text-gray-400">
                      ...
                      <span>{user.countryName || "Global"}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    {user.instagram && (
                      <p className="text-sm">
                        <span className="text-gray-400">Instagram:</span> {user.instagram}
                      </p>
                    )}
                    {user.snapchat && (
                      <p className="text-sm">
                        <span className="text-gray-400">Snapchat:</span> {user.snapchat}
                      </p>
                    )}
                    {user.facebook && (
                      <p className="text-sm">
                        <span className="text-gray-400">Facebook:</span> {user.facebook}
                      </p>
                    )}
                    {user.discord && (
                      <p className="text-sm">
                        <span className="text-gray-400">Discord:</span> {user.discord}
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="bg-green-900/50 border border-green-700 rounded-lg p-3 text-center">
                    ...
                    {user.subscriptionDate && (
                      <p className="text-green-400 text-xs mt-1">
                        Subscribed since {new Date(user.subscriptionDate).toLocaleDateString()}
                      </p>
                    )}
                  </div>
                ) : (
